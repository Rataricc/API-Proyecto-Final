...
public class EmprendimientoService {
    ...
    public Emprendimiento crearEmprendimiento(OperacionEmprendimiento operacionEmprendimiento){
        ...
        emprendimiento.setObjetivoRecaudacion(operacionEmprendimiento.getObjetivoRecaudacion());
